/* Short method practise from Codingbat.com - Logic problems
...
public int sumLimit(int a, int b) {
  ...
  int lenAB = String.valueOf(a + b).length();
...
utcome of the party encoded as 0=bad, 1=good, or 2=great. A party is good 
...
arameter "you" is the stylishness of your clothes, in the range 0..10, and 
